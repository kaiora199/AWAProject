...
INSERT INTO users (user_email, user_password, user_fullname, orders_id)
VALUES ('matti@gmail.com','1234','Matti Meikäläinen' , '1');

INSERT INTO restaurants (name, priceLevel, address, operatingHours, restaurantType)
VALUES ('Pizzeria nönnönöö','€€€€','Isokatu 1', '15-24', 'Fast food');

INSERT INTO food (title, price, description, restaurants_id)
VALUES ('Börsä','19.95','loistava börsä', '1');
